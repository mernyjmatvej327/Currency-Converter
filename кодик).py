...
class CurrencyConverter:
    def __init__(self, root):
        ...
        # Фиксированные курсы (можно обновлять вручную)
        self.exchange_rates = {
            "USD": 92.50,
            "EUR": 99.80,
            "GBP": 117.20,
    ...
    def convert_currency(self):
        try:
            ...
            # Расчёт курса
            rate_from = self.exchange_rates[from_curr]
            rate_to = self.exchange_rates[to_curr]

            # Конвертация через рубли (промежуточная валюта)
